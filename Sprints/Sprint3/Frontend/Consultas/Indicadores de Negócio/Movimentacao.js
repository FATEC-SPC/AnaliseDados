...
async function run() {
    ...
    if(sumPcl > sumTot){
        ...
        console.log("ERRO!! O valor Total Mínimo por Remessa é maior que Valor Total Fatura por Remessa")
    }
    else if(sumTot < sumSDO){
        console.log("ERRO!! O Valor Total Fatura por Remessa é maior que o Total Utilizado por Remessa")
    }
    else {
